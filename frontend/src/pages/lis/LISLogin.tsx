  ...
  return (
    <main className="pt-32 pb-20 min-h-screen flex items-center">
      <div className="max-w-4xl mx-auto px-8 w-full">
        <div className="bg-sjcs-surface-container-lowest p-12 rounded-xl shadow-2xl shadow-slate-200/50 max-w-lg mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-2xl font-bold font-headline mb-2">Welcome Back</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full leadership-gradient text-white py-4 rounded-lg font-bold uppercase tracking-[0.2em] text-xs shadow-lg hover:shadow-sjcs-primary/30 transition-all mt-4 disabled:opacity-50"
            >
